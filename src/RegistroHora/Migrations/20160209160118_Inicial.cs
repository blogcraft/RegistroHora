...
namespace RegistroHora.Migrations
{
    public partial class Inicial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumHoras = table.Column<decimal>(nullable: false),
                    TipoHoras = table.Column<string>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FechaCompromiso = table.Column<DateTime>(nullable: false),
                    FechaInicio = table.Column<DateTime>(nullable: false),
                    Nombre = table.Column<string>(nullable: false),
                    PorcAvance = table.Column<decimal>(nullable: false),
                    TipoProyectoId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable("Proyecto");
            migrationBuilder.DropTable("AspNetUsers");
            migrationBuilder.DropTable("Cliente");
            migrationBuilder.DropTable("TipoProyecto");
        }
    }
}
